...
def chatgpt(prompt, count, driver) :
    ...
    time.sleep(2)
    setting_element = driver.webdriver.find_element(By.CSS_SELECTOR, "#headlessui-menu-item-\\:r1l\\:")
    time.sleep(2)
    setting_element.click()
    time.sleep(2)
    data_tab = driver.webdriver.find_element(By.CSS_SELECTOR, "#radix-\\:r1q\\:-trigger-DataControls")
    time.sleep(2)
    data_tab.click()
    time.sleep(2)
    turn_off = driver.webdriver.find_element(By.CSS_SELECTOR, "#radix-\\:r1q\\:-content-DataControls > div > div:nth-child(1) > div.flex.items-center.justify-between > button")
    time.sleep(2)
    turn_off.click()
    time.sleep(2)
    close_element = driver.webdriver.find_element(By.CSS_SELECTOR, "#radix-\\:r1n\\: > div.px-4.pb-4.pt-5.sm\\:p-6.flex.items-center.justify-between.border-b.border-black\\/10.dark\\:border-white\\/10 > button")
    time.sleep(2)
    close_element.click()
